...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        pixel: ["'NeoDunggeunmo'", "'Press Start 2P'", "cursive"],
      ...
      colors: {
        ...
        "pixel-yellow": "hsl(var(--pixel-yellow))",
        "pixel-lavender": "hsl(var(--pixel-lavender))",
      ...
      keyframes: {
        ...
        "pixel-fade-in": {
          ...
          "50%": { opacity: "0.6", filter: "blur(4px) saturate(0.5)" },
